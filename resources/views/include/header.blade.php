...
<head>
    ...
    <!-- jquery-ui css -->
    <link href="{{baseUrl.'/plugins/jquery-ui-1.12.1/jquery-ui.min.css'}} " rel="stylesheet" type="text/css" />
    <!-- Bootstrap -->
    <link href="{{baseUrl.'/bootstrap/css/bootstrap.min.css'}}" rel="stylesheet" type="text/css" />
    <!-- Bootstrap rtl -->
    <!--<link href="assets/bootstrap-rtl/bootstrap-rtl.min.css" rel="stylesheet" type="text/css"/>-->
    <!-- Lobipanel css -->
    <link href="{{baseUrl.'/plugins/lobipanel/lobipanel.min.css'}}" rel="stylesheet" type="text/css" />
    <!-- Pace css -->
    <link href="{{baseUrl.'/plugins/pace/flash.css'}}" rel="stylesheet" type="text/css" />
    <!-- Font Awesome -->
    <link href="{{baseUrl.'/font-awesome/css/font-awesome.min.css'}}" rel="stylesheet" type="text/css" />
    <!-- Pe-icon -->
    <link href="{{baseUrl.'/pe-icon-7-stroke/css/pe-icon-7-stroke.css'}}" rel="stylesheet" type="text/css" />
    <!-- Themify icons -->
    <link href="{{baseUrl.'/themify-icons/themify-icons.css'}}" rel="stylesheet" type="text/css" />
    <!-- End Global Mandatory Style
         =====================================================================-->
    <!-- Start page Label Plugins
         =====================================================================-->
    <!-- Emojionearea -->
    <link href="{{baseUrl.'/plugins/emojionearea/emojionearea.min.css'}}" rel="stylesheet" type="text/css" />
    <!-- Monthly css -->
    <link href="{{baseUrl.'/plugins/monthly/monthly.css'}}" rel="stylesheet" type="text/css" />
    <!-- End page Label Plugins
         =====================================================================-->
    <!-- Start Theme Layout Style
         =====================================================================-->
    <!-- Theme style -->
    <link href="{{baseUrl.'/dist/css/stylecrm.css'}}" rel="stylesheet" type="text/css" />
    <!-- Theme style rtl -->
        ...
        <header class="main-header">
            <a href="index.html" class="logo">
                ...
                <span class="logo-mini">
                    <img src="{{baseUrl.'/dist/img/mini-logo.png'}}" alt="">
                </span>
                <span class="logo-lg">
                    <img src="{{baseUrl.'/dist/img/logo.png'}}" alt="">
                </span>
            </a>
            <!-- Header Navbar -->
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <ul class="menu">
                                        <li>
                                            <a href="#" class="border-gray">
                                                <i class="fa fa-dot-circle-o color-green"></i>Change Your font
                                                style</a>
                                        </li>
