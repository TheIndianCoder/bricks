<aside class="main-sidebar">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active">
                <a href="{{route('landOwner.list')}}"><i class="fa fa-tachometer"></i><span>Accure Land</span>
                    <span class="pull-right-container">
                    </span>
                </a>
            </li>
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{route('employee.addView')}}">Add Employee</a></li>
                    <li><a href="{{route('employee.list')}}">List</a></li>
                    <li><a href="{{route('employee.group.list')}}">Groups</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-users"></i><span>Labour Sardar</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{route('sardar.list')}}">Add Sardar</a></li>
                    <li><a href="{{route('sardar.list')}}">List</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{route('vehical.vehicalList')}}">Vehicle List</a></li>
                    <li><a href="deposit.html">Add Vehicle</a></li>                    
                    <li><a href="{{route('vehical.G.list')}}">Vehicle Group</a></li>
                    <li><a href="{{route('vehical.ownerList')}}">Vehicle Owner</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-shopping-cart"></i><span>Soil</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{route('soilOwner.list')}}">Soil Owners</a></li>
                    <li><a href="{{route('soilOwner.list')}}">Add Trip</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-shopping-cart"></i><span>Sand</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{route('sandTip.list')}}">Sand Owners</a></li>
                    <li><a href="{{route('sandTip.list')}}">Add Trip</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-shopping-cart"></i><span>Coal</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{route('soilOwner.list')}}">Coal Owners</a></li>
                    <li><a href="{{route('soilOwner.list')}}">Add Coal Trip</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-shopping-cart"></i><span>Row Material</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
